...
$stringBuscar="select nick_usuario from usuario "
        . "where nick_usuario='".$nick_personal."'";
...
var pais_personal="<?php echo $pais_personal?>";
var disponible="<?php echo $cantidadBuscar ?>";
