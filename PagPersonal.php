                                    ...
                                    <div class="new_posts">
                                        <div class="vertical_post">
                                            ...
                                            <form name="form_password" id="form_password">
                                                ...
                                                <input type="text" class="text" id="passnew01" name="passnew01" value="contraseï¿½a" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                this.value = 'contraseï¿½a';}">
                                                <span>Repita contrase&ntilde;a</span>
                                                <input type="text" class="text" id="passnew02" name="passnew02" value="contraseï¿½a" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                this.value = 'contraseï¿½a';}">
